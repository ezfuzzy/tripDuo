                ...
                <div className="privacy_content">
                    <div className="inner">
                        ...
                        <div className="content_box">
                            <pre>개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
                                <pre style={{ fontSize: '16px', fontWeight: 'bold' }}>1. 수집하는 개인정보 </pre>
                                이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 네이버 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 네이버는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
                                <pre style={{ fontWeight: 'bold' }}>회원가입 시점에 네이버가 이용자로부터 수집하는 개인정보는 아래와 같습니다.</pre>
                                ...
                                <pre style={{ fontWeight: 'bold' }}>서비스 이용 과정에서 이용자로부터 수집하는 개인정보는 아래와 같습니다.</pre>
                                ...
                                <pre style={{ fontWeight: 'bold' }}>서비스 이용 과정에서 IP 주소, 쿠키, 서비스 이용 기록, 기기정보, 위치정보가 생성되어 수집될 수 있습니다. 또한 이미지 및 음성을 이용한 검색 서비스 등에서 이미지나 음성이 수집될 수 있습니다.</pre>
                                ...
                                <br />
                                <span style={{ fontWeight: 'bold' }}>생성정보 수집에 대한 추가 설명 </span>
                                ...
                                <br />
                                <a href="https://privacy.naver.com/knowledge/cookie?menu=knowledge_info_relation_cookie">쿠키에 관한 자세한 내용(네이버 프라이버시 센터) 알아보기</a>
                                <br /><br />
                                <pre style={{ fontSize: '16px', fontWeight: 'bold' }}>2. 수집한 개인정보의 이용</pre>
                                ...
                                <pre style={{ fontSize: '16px', fontWeight: 'bold' }}>3. 개인정보 보관기간</pre>
                                <pre style={{ fontWeight: 'bold' }}>회사는 원칙적으로 이용자의 개인정보를 회원 탈퇴 시 지체없이 파기하고 있습니다. 단, 이용자에게 개인정보 보관기간에 대해 별도의 동의를 얻은 경우, 또는 법령에서 일정 기간 정보보관 의무를 부과하는 경우에는 해당 기간 동안 개인정보를 안전하게 보관합니다. 이용자에게 개인정보 보관기간에 대해 회원가입 시 또는 서비스 가입 시 동의를 얻은 경우는 아래와 같습니다.</pre>
                                - 부정 가입 및 이용 방지
                                ...
                                <pre style={{ fontWeight: 'bold' }}>전자상거래 등에서의 소비자 보호에 관한 법률, 전자문서 및 전자거래 기본법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. 네이버는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.</pre>
                                ...
                                - 통신비밀보호법
                                로그인 기록: 3개월
                                <pre style={{ fontSize: '16px', fontWeight: 'bold' }}>4. 개인정보 수집 및 이용 동의를 거부할 권리</pre>
