  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">비밀번호 변경</h2>
      </div>

      <form className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-6 sm:gap-x-4">
          <div className="sm:col-span-6">
            <label className="block text-sm font-semibold leading-6 text-gray-900">현재 비밀번호:</label>
            <input
              type="password"
          ...
          <div className="sm:col-span-6">
            <label className="block text-sm font-semibold leading-6 text-gray-900">새 비밀번호:</label>
          ...
          <div className="sm:col-span-6">
            <label className="block text-sm font-semibold leading-6 text-gray-900">새 비밀번호 확인:</label>
            <div className="mt-2.5">
              <input
                type="password"
              ...
              />
              {!isPasswordMatched && (
                <p className="mt-2 text-sm text-red-600">새 비밀번호와 확인 비밀번호가 일치하지 않습니다.</p>
              )}
            </div>
          </div>
